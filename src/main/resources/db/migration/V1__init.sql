...
-- Tabela de usuarios
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE TB_USUARIO_INVESTIMENTO CASCADE CONSTRAINTS';
    EXCEPTION WHEN OTHERS THEN NULL;
END;
/

BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE TB_INVESTIMENTO CASCADE CONSTRAINTS';
    EXCEPTION WHEN OTHERS THEN NULL;
END;
/

BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE TB_TIPO_INVESTIMENTO CASCADE CONSTRAINTS';
    EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
CREATE TABLE TB_USUARIO_INVESTIMENTO (
...
CREATE INDEX IDX_INVESTIMENTO_TIPO ON TB_INVESTIMENTO(id_tipo);
CREATE INDEX IDX_USUARIO_INV_USUARIO ON TB_USUARIO_INVESTIMENTO(id_usuario);
CREATE INDEX IDX_USUARIO_INV_INVESTIMENTO ON TB_USUARIO_INVESTIMENTO(id_investimento);
